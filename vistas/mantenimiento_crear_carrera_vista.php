...
bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'INGRESO', 'A MANTENIMIENTO/CREAR CARRERA');
...
if ($visualizacion == 0) {
    ...
    if (permisos::permiso_insertar($Id_objeto) == '1') {
        $_SESSION['btn_guardar_carrera'] = "";
    } else {
        $_SESSION['btn_guardar_carrera'] = "disabled";
    }
    /*
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid ">
                ...
                <form action="../Controlador/guardar_carrera_controlador.php" method="post" data-form="save" class="FormularioAjax" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-center" style="margin-top: 20px;">
                                        <button type="submit" class="btn btn-primary" id="btn_guardar_carrera" name="btn_guardar_carrera" <?php echo $_SESSION['btn_guardar_carrera']; ?>><i class="zmdi zmdi-floppy"></i> Guardar</button>
                                    </p>
