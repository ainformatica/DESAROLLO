...
bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'Ingresó', 'A Editar Estado Acuerdo');
            ...
            <form role="form" name="guardar-estadoacuerdo" id="guardar-estadoacuerdo" method="post" action="../Modelos/modelo_manacuerdo.php">
                <div class="card-body" style="padding-top: 100px;">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $estado['estado_acuerdo']; ?>" class="form-control" class="form-control col-md-6" id="estado" name="estado" onkeyup="MismaLetra('estado');" placeholder="Ingrese un estado nuevo. (Mínimo 3 caracteres)" required title="Solo se permiten MAYÚSCULAS y no se Aceptan caracteres especiales" minlength="3" maxlength="15" pattern="[A-Z\s]{1,15}">
                    </div>
                </div>
                <!-- /.card-body -->
...
<div class="modal-dialog modal-dialog-centered modal-sm justify-content-center">
    <div class="modal-content lg-secondary">
        ...
        <div class="modal-footer justify-content-center">
            <a style="color: white ;" type="button" class="btn btn-primary" href="mantenimiento_estadoacuerdo_vista">Sí, deseo cancelar</a>
