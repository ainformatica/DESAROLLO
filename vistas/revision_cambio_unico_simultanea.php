...
if (isset($_GET['alumno'])) {
  ...
  $sqltabla = json_decode(file_get_contents("http://desarrollo.informaticaunah.com/api/carrera_simultanea.php?alumno=" . $_GET['alumno']), true);
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../vistas/revision_cambio_carrera_simultanea_vista.php">Solicitudes de Cambio Carrera Simultánea</a></li>
            </ol>
          </div>
