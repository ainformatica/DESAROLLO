...
if (isset($_REQUEST['msj'])) {
  ...
  if ($msj == 2) {
    ...
    $sqltabla = "select ubicacion FROM tbl_ubicacion";
...
if ($visualizacion == 0) {
  ...
  if (permisos::permiso_modificar($Id_objeto) == '1') {
    $_SESSION['btn_modificar_ubicacion'] = "";
  } else {
    $_SESSION['btn_modificar_ubicacion'] = "disabled";
  }
...
FROM tbl_ubicacion";
 ...
 tabla donde ubicacion sea igual al que se ingreso en el input */
    $sql = "select * FROM tbl_ubicacion WHERE ubicacion = '$ubicacion'";
...
?>
      <script>
        $(function() {
          $('#modal_modificar_ubicacion').modal('toggle')
...
<body>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-default">
      <div class="card-header">
        <h3 class="card-title">Ubicaciones Existentes</h3>
            ...
            <?php while ($row = $resultadotabla->fetch_array(MYSQLI_ASSOC)) { ?>
              <tr>
                ...
                <td style="text-align: center;">
                  ...
                  <a href="../vistas/mantenimiento_ubicacion_vista.php?ubicacion=<?php echo $row['ubicacion']; ?>" class="btn btn-primary btn-raised btn-xs">
                    <i class="far fa-edit" style="display:<?php echo $_SESSION['btn_modificar_ubicacion'] ?> "></i>
                  </a>
                </td>

                <td style="text-align: center;">

                  <form action="../Controlador/eliminar_ubicacion_controlador.php?ubicacion=<?php echo $row['ubicacion']; ?>" method="POST" class="FormularioAjax" data-form="delete" autocomplete="off">
                    <button type="submit" class="btn btn-danger btn-raised btn-xs">

                      <i class="far fa-trash-alt" style="display:<?php echo $_SESSION['btn_eliminar_ubicacion'] ?> "></i>
                    </button>
                    <div class="RespuestaAjax"></div>
                  </form>
                </td>
  ...
  <form action="../Controlador/actualizar_ubicacion_controlador.php?id_ubicacion=<?php echo $_SESSION['id_ubicacion']; ?>" method="post" class="FormularioAjax" data-form="update" autocomplete="off">



    <div class="modal fade" id="modal_modificar_ubicacion">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <button type="submit" class="btn btn-primary" id="btn_modificar_ubicacion" name="btn_modificar_ubicacion" <?php echo $_SESSION['btn_modificar_ubicacion']; ?>>Guardar Cambios</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
