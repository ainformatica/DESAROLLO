        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-header with-border">
              <h1 align="right"><button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar Solicitud</button></h1>
              ...
              <div class="panel-body table-responsive" id="listadoregistros2">
                <table id="tbllistado2" class="table table-striped table-bordered table-condensed table-hover">
                  <div class="col-sm-12">
                  <h4>ACTIVIDADES APROBADAS/FINALIZADAS</h4>
                 </div>
                  <thead>
                    <th>Opciones</th>
