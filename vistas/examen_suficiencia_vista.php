  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Solicitud de Examen de Suficiencia por Código</h1>
          </div>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../vistas/menu_suficiencia_vista.php">Examen de Suficiencia por Código</a></li>
            </ol>
          </div>
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Solicitud de Examen de Suficiencia</label>
