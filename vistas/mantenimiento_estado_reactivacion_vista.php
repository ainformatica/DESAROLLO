...
if ($visualizacion == 0) {
    ...
    bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'INGRESO', 'A MANTENIMIENTO ESTADO REACTIVACION');


    if (permisos::permiso_modificar($Id_objeto) == '1') {
        $_SESSION['btn_modificar_estado_reactivacion'] = "";
    } else {
        $_SESSION['btn_modificar_estado_reactivacion'] = "disabled";
    }
 ...
 tabla donde rol sea igual al que se ingreso en el input */
        $sql = "select * FROM tbl_estado_reactivacion WHERE estado = '$estado'";
        ...
        $_SESSION['id_estado_reactivacion'] = $row['id_estado_reactivacion'];
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1>Estado Reactivacion de Cuenta
                        </h1>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="../vistas/mantenimiento_crear_estado_reactivacion_vista.php">Nuevo Estado</a></li>
                        </ol>
                    </div>
                        ...
                        <?php while ($row = $resultadotabla->fetch_array(MYSQLI_ASSOC)) { ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <a href="../vistas/mantenimiento_estado_reactivacion_vista.php?estado=<?php echo $row['estado']; ?>" class="btn btn-primary btn-raised btn-xs">
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <form action="../Controlador/eliminar_estado_reactivacion_controlador.php?estado=<?php echo $row['estado']; ?>" method="POST" class="FormularioAjax" data-form="delete" autocomplete="off">
...
-->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Modificar Descripción</label>
    ...
    <script type="text/javascript" language="javascript">
        function ventana() {
            window.open("../Controlador/reporte_mantenimiento_estado_reactivacion_controlador.php", "REPORTE");
        }
    </script>
