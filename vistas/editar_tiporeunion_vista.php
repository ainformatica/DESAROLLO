...
bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'Ingresó', 'A Editar Tipo Reunión');
            ...
            <form role="form" name="guardar-tiporeu" id="guardar-tiporeu" method="post" action="../Modelos/modelo_manactareunion.php">
                <div class="card-body" style="padding-top: 100px;">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $tipo['tipo']; ?>" class="form-control" class="form-control col-md-6" id="tipo" name="tipo"onkeyup="MismaLetra('tipo');" placeholder="Ingrese un tipo nuevo. (Mínimo 3 caracteres)" required title="Solo se permiten MAYÚSCULAS y no se Aceptan caracteres especiales" minlength="3" maxlength="15" pattern="[A-Z\s]{1,15}">
                    </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer" style="background: white;">
                    <input type="hidden" name="tipo-actareunion" value="actualizar">
                    <input type="hidden" name="id_tipo" value="<?php echo $id; ?>">
...
<div class="modal-dialog modal-dialog-centered modal-sm justify-content-center">
    <div class="modal-content lg-secondary">
        ...
        <div class="modal-footer justify-content-center">
            <a style="color: white ;" type="button" class="btn btn-primary" href="mantenimiento_actareunion_vista">Sí, deseo cancelar</a>
