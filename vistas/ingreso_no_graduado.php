  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Solicitud de Admisión a la Carrera</h1>
          </div>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../pdf/no_graduado.php" target="_blank">Requisitos</a></li>
            </ol>
          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="hidden" id="txt_no_graduado" name="txt_no_graduado" value="NO GRADUADO">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="file" id="txt_constancia" name="txt_constancia">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
