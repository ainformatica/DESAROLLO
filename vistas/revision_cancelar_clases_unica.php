  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Solicitud Cancelación de Clases</h1>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  $listar = null;
                  $directorio = opendir("../archivos/cancelar_clases/$cuenta/");
                  while ($elemento = readdir($directorio)) {
                    if ($elemento != '.' and $elemento != '..') {


                      if (is_dir("../archivos/cancelar_clases/$cuenta/" . $elemento)) {
                        $listar .= "<li> <a href='../archivos/cancelar_clases/$cuenta/$elemento' target='_blank'>$elemento/</a></li>";
                      } else {
                        $listar .= "<li> <a href='../archivos/cancelar_clases/$cuenta/$elemento' target='_blank'>$elemento</a></li>";
                      }
                    }
