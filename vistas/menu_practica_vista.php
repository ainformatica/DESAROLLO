...
{
$_SESSION['registrar_clases_aprobadas_menu']="No tiene permisos para visualizar";
}

if (permiso_ver('2000')=='1')
 {
...
if (permiso_ver('2007')=='1')
 {
  
  $_SESSION['gestion_charla_menu']="...";
}
else
{
$_SESSION['gestion_charla_menu']="No 
  tiene permisos para visualizar";

}

if (permiso_ver('2006')=='1')
 {
...
<div class="col-6 col-sm-6 col-md-4">
  ...
  <a href="../vistas/gestion_charla_vista.php" class="small-box-footer">
   ...
   <div class="small-box bg-light">
   <div class="inner">
    <h5>Gestión de Asistencia de Charla</h5>
