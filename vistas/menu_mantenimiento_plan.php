...
if (permiso_ver('108') == '1') {
  ...
  $_SESSION['mantenimiento_asignatura_vista'] = "No 
  tiene permisos para visualizar";
}
if (permiso_ver('109') == '1') {

  $_SESSION['mantenimiento_crear_asignatura_servicio_vista'] = "...";
} else {
  $_SESSION['mantenimiento_crear_asignatura_servicio_vista'] = "No 
  tiene permisos para visualizar";
}
if (permiso_ver('110') == '1') {

  $_SESSION['mantenimiento_asignatura_servicio_vista'] = "...";
} else {
  $_SESSION['mantenimiento_asignatura_servicio_vista'] = "No 
  tiene permisos para visualizar";
}
if (permiso_ver('93') == '1') {
  ...
  <div class="wrapper">
    ...
    justify-content: center;">
                    ...
                    <div class="col-6 col-sm-6 col-md-4">
                      <div class="small-box bg-light">
                        <div class="inner">
                          ...
                          <p><?php echo $_SESSION['mantenimiento_crear_asignatura_vista']; ?></p>
                        </div>
                        <div class="icon">
                          <i class="fas fa-plus-square"></i>
                        </div>

                        <a href="../vistas/mantenimiento_crear_asignatura_vista.php" class="small-box-footer">
                          Ir <i class="fas fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    ...
                    <div class="col-6 col-sm-6 col-md-4">
                      <div class="small-box bg-primary">
                        <div class="inner">
                          <h4>Mantenimiento Asignatura </h4>
                          <p><?php echo $_SESSION['mantenimiento_asignatura_vista']; ?></p>
                        </div>
                        <div class="icon">
                          <i class="fas fa-edit"></i>
                        </div>

                        <a href="../vistas/mantenimiento_asignatura_vista.php" class="small-box-footer">
                          Ir <i class="fas fa-arrow-circle-right"></i>
                        </a>
                      </div>
                      <!-- /.info-box -->
    ...
    justify-content: center;">
                    ...
                    <div class="col-6 col-sm-6 col-md-4">
                      <div class="small-box bg-light">
                        ...
                        <a href="../vistas/mantenimiento_crear_asignatura_servcio_vista.php" class="small-box-footer">
                          Ir <i class="fas fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    ...
                    <div class="col-6 col-sm-6 col-md-4">
                      <div class="small-box bg-primary">
                        ...
                        <a href="../vistas/mantenimiento_asignatura_servicio_vista.php" class="small-box-footer">
                          Ir <i class="fas fa-arrow-circle-right"></i>
                        </a>
                      </div>
                      <!-- /.info-box -->
