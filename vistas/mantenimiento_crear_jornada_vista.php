...
bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'INGRESO', 'A MANTENIMIENTO/CREAR JORNADA');
...
if ($visualizacion == 0) {
    ...
    if (permisos::permiso_insertar($Id_objeto) == '1') {
        $_SESSION['btn_guardar_jornada'] = "";
    } else {
        $_SESSION['btn_guardar_jornada'] = "disabled";
    }
    /*
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid ">
                ...
                <form action="../Controlador/guardar_jornada_controlador.php" method="post" data-form="save" class="FormularioAjax" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-center" style="margin-top: 20px;">
                                        <button type="submit" class="btn btn-primary" id="btn_guardar_jornada" name="btn_guardar_jornada" <?php echo $_SESSION['btn_guardar_jornada']; ?>><i class="zmdi zmdi-floppy"></i> Guardar</button>
                                    </p>
