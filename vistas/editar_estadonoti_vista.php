...
bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'Ingresó', 'A Editar Estado Notificación');
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <?php
            $sql = "SELECT * FROM `tbl_estado_notificacion` WHERE `id_estado_notificacion` = $id ";
            ...
            <form role="form" name="guardar-estadonoti" id="guardar-estadonoti" method="post" action="../Modelos/modelo_mannoti.php">
                <div class="card-body" style="padding-top: 100px;">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $estado['estado']; ?>" class="form-control" class="form-control col-md-6" id="estado" name="estado" placeholder="Ingrese un estado nuevo. (Mínimo 3 caracteres)" required title="Solo se permiten MAYÚSCULAS y no se Aceptan caracteres especiales" onkeyup="MismaLetra('estado');" minlength="3" maxlength="15" pattern="[A-Z\s]{1,15}">
                    </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer" style="background: white;">
                    <input type="hidden" name="estado-noti" value="actualizar">
    ...
    <div class="modal-content lg-secondary">
        ...
        <div class="modal-footer justify-content-center">
            <a style="color: white ;" type="button" class="btn btn-primary" href="mantenimiento_estadonoti_vista">Sí, deseo cancelar</a>
