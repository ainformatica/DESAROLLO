...
if ($visualizacion == 0) {
  ...
  bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'INGRESO', 'A UNICA SUPERVISION.');
...
<body>
            ...
            <div class="card-body">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <select class="form-control" name="oportunidad_empleo_uv" id="oportunidad_empleo_uv">
                    <option value="" require>Seleccione</option>
                    <option value="Si">SI</option>
                    <option value="No">NO</option>
  ...
  <script type="text/javascript">
    ...
    function llenarCampos(inputSelect) {
      ...
      $.post("../Controlador/guardar_unica_visita_controlador.php?op=rellenarDatos", {
