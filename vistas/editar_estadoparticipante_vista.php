...
bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'Ingresó', 'A Editar Estado Participante');
...
<body>
    ...
    <div class="modal-content lg-secondary">
        ...
        <div class="modal-footer justify-content-center">
            <a style="color: white ;" type="button" class="btn btn-primary" href="mantenimiento_estadoparticipante_vista" >Sí, deseo cancelar</a>
