...
bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'INGRESO', 'A MANTENIMIENTO/CREAR ESTADO CIVIL');
...
if ($visualizacion == 0) {
    ...
    if (permisos::permiso_insertar($Id_objeto) == '1') {
        $_SESSION['btn_guardar_estado_civil'] = "";
    } else {
        $_SESSION['btn_guardar_estado_civil'] = "disabled";
    }
    /*
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="../vistas/mantenimiento_estado_civil_vista.php"> Mantenimiento Estado Civil</a></li>
                        </ol>
                    </div>
        ...
        <section class="content">
            <div class="container-fluid ">
                ...
                <form action="../Controlador/guardar_estado_civil_controlador.php" method="post" data-form="save" class="FormularioAjax" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-center" style="margin-top: 20px;">
                                        <button type="submit" class="btn btn-primary" id="btn_guardar_estado_civil" name="btn_guardar_estado_civil" <?php echo $_SESSION['btn_guardar_estado_civil']; ?>><i class="zmdi zmdi-floppy"></i> Guardar</button>
                                    </p>
