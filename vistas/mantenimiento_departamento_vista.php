...
if ($visualizacion == 0) {
  ...
  bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'Ingreso', 'A Mantenimiento Departamento');


  if (permisos::permiso_modificar($Id_objeto) == '1') {
    $_SESSION['btn_modificar_departamento'] = "";
  } else {
...
FROM tbl_departamentos";
 ...
 tabla donde rol sea igual al que se ingreso en el input */
    $sql = "select * FROM tbl_departamentos WHERE departamento = '$departamento'";
...
?>
      <script>
        $(function() {
          $('#modal_modificar_departamento').modal('toggle')
            ...
            <?php while ($row = $resultadotabla->fetch_array(MYSQLI_ASSOC)) { ?>
              <tr>
                ...
                <td style="text-align: center;">
                  ...
                  <a href="../vistas/mantenimiento_departamento_vista.php?departamento=<?php echo $row['departamento']; ?>" class="btn btn-primary btn-raised btn-xs">
                    <i class="far fa-edit" style="display:<?php echo $_SESSION['modificar_departamento'] ?> "></i>
                  </a>
                </td>

                <td style="text-align: center;">

                  <form action="../Controlador/eliminar_departamento_controlador.php?departamento=<?php echo $row['departamento']; ?>" method="POST" class="FormularioAjax" data-form="delete" autocomplete="off">
                    <button type="submit" class="btn btn-danger btn-raised btn-xs">

                      <i class="far fa-trash-alt" style="display:<?php echo $_SESSION['eliminar_departamento'] ?> "></i>
                    </button>
                    <div class="RespuestaAjax"></div>
                  </form>
                </td>
...
-->
  <form action="../Controlador/actualizar_departamento_controlador.php?id_departamento=<?php echo $_SESSION['id_departamento']; ?>" method="post" data-form="update" autocomplete="off">

    <div class="modal fade" id="modal_modificar_departamento">
