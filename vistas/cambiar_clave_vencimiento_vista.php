      ...
      <div class="card-body login-card-body">
        ...
        <form action="../Controlador/actualizar_cambiar_clave_vencimiento_controlador.php" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <input class="form-control" type="password" id="txt_claveactualV" name="txt_claveactualV" onkeyup="Espacio(this, event)" required oncopy="return false" onpaste="return false" maxlength="10">
          ...
          <div class="input-group mb-3">
            ...
            <input class="form-control" type="password" id="txt_clavenuevaV" name="txt_clavenuevaV" onkeyup="Espacio(this, event)" required oncopy="return false" onpaste="return false" maxlength="10">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3">
            <input class="form-control" type="password" id="txt_confirmarclaveV" name="txt_confirmarclaveV" onkeyup="Espacio(this, event)" required oncopy="return false" onpaste="return false" maxlength="10">
            <div class="input-group-append">
              <div class="input-group-text">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#show-hide-passwd1').click(function() {
        if ($(this).hasClass('fa-eye')) {
          $('#txt_clavenuevaV').removeAttr('type');
          $('#show-hide-passwd1').addClass('fa-eye-slash').removeClass('fa-eye');
        } else {
          //Establecemos el atributo y valor
          $('#txt_clavenuevaV').attr('type', 'password');
    ...
    $(document).ready(function() {
      ...
      $('#show-hide-passwd2').click(function() {
        if ($(this).hasClass('fa-eye')) {
          $('#txt_confirmarclaveV').removeAttr('type');
          $('#show-hide-passwd2').addClass('fa-eye-slash').removeClass('fa-eye');
        } else {
          //Establecemos el atributo y valor
          $('#txt_confirmarclaveV').attr('type', 'password');
