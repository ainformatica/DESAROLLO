              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="txt_centro_regional" name="txt_centro_regional" value="CIUDAD UNIVERSITARIA" required onkeypress="return Letras(event)" onkeyup="DobleEspacio(this, event)" style="text-transform: uppercase" maxlength="12" readonly>
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <label> Carrera </label>
                    <input class="form-control" type="text" id="txt_carrera" name="txt_carrera" value="INFORMATICA ADMINISTRATIVA" required onkeypress="return Letras(event)" onkeyup="DobleEspacio(this, event)" style="text-transform: uppercase" maxlength="60" readonly>
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="txt_beneficiario_directo" name="txt_beneficiario_directo" value="" required onkeyup="Espacio(this, event)" onkeypress="return Numeros(event)" maxlength="4" onblur="calcular_total();">
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="txt_beneficiario_indirecto" name="txt_beneficiario_indirecto" value="" required onkeyup="Espacio(this, event)" onkeypress="return Numeros(event)" maxlength="4" onblur="calcular_total();">
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <label> Total </label>
                    <input class="form-control" type="text" id="txt_beneficiarios" name="txt_beneficiarios" required onkeyup="Espacio(this, event)" onkeypress="return Numeros(event)" maxlength="4" readonly>
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="combo_modalidad" id="combo_modalidad" required="">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="txt_costo_proyecto" name="txt_costo_proyecto" value="" required onkeypress="return Numeros(event)" onkeyup="Espacio(this, event)" style="text-transform: uppercase" maxlength="12">
                  </div>
                </div>
                ...
                <input class="form-control" type="text" id="id_municipio" name="id_municipio" hidden>

                <input class="form-control" type="text" id="id_aldea" name="id_aldea" hidden>

                <input class="form-control" type="text" id="id_depto" name="id_depto" hidden>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="txt_actividades_principales" name="txt_actividades_principales" value="" required onkeyup="DobleEspacio(this, event)" style="text-transform: uppercase" maxlength="120"> </textarea>
                  </div>
                </div>
...
<script src="../js/registro_proyecto_vinculacion.js"></script>