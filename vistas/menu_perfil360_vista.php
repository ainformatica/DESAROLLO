...
$sql = $mysqli->prepare("SELECT p.id_persona, p.nombres,p.apellidos,p.identidad, p.fecha_nacimiento, pe.valor, u.Id_rol
...
$_SESSION['saludo'] = $id_per;
// function id_personafun(){
//$GLOBALS['id_pers_logueada'] = $GLOBALS['id_per'];
// }
...
<body>
  ...
  <div class="wrapper">
   ...
   <input type="submit" value="Buscar" class="btn_search"> -->
                ...
                if ($_SESSION["rol"] == "56") {
                  echo '<input type="text" name="busqueda" id="busqueda" placeholder="Numero de cuenta">
   <input type="submit" value="Buscar" class="btn btn-primary" style="margin-left:10px; padding: 0 30px; border: 0;">';
                  //echo "Contenido arriba";
                } elseif ($_SESSION["rol"] == "46") {
                  echo '<input type="text" name="busqueda" id="busqueda" placeholder="Numero de cuenta">
   <input type="submit" value="Buscar" class="btn btn-primary" style="margin-left:10px; padding: 0 30px; border: 0;">';
                } else {
                  echo '<input type="text" disable>
    <input type="submit" value="Buscar" class="btn_sear" disabled>';
