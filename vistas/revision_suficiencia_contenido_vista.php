...
if ($visualizacion == 0) {
  ...
  bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'INGRESO', 'A REVISION SOLICITUDES EXAMEN SUFUCIENCIA');
}
...
$sql_tabla = json_decode(file_get_contents('http://desarrollo.informaticaunah.com/api/examen_suficiencia_api.php'), true);
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1>Solicitudes de Exámenes de Suficiencia por Contenido</h1>
          </div>
