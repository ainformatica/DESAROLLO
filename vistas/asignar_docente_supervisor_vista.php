...
if ($visualizacion == 0) {
  ...
  bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'INGRESO', 'A ASIGNAR UN DOCENTE SUPERVISOR.');

  if (permisos::permiso_modificar($Id_objeto) == '1') {
    $_SESSION['btn_asignar_docente'] = "";
  } else {
    $_SESSION['btn_asignar_docente'] = "disabled";
  }
}
