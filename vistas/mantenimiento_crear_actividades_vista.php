...
if ($visualizacion == 0) {
    ...
    if (permisos::permiso_insertar($Id_objeto) == '1') {
        $_SESSION['btn_guardar_actividad'] = "";
    } else {
        $_SESSION['btn_guardar_actividad'] = "disabled";
    }
    /*
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid ">
                ...
                <form action="../Controlador/guardar_actividad_controlador.php" method="post" data-form="save" class="FormularioAjax" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-center" style="margin-top: 20px;">
                                        <button type="submit" class="btn btn-primary" id="btn_guardar_actividad" name="btn_guardar_actividad" <?php echo $_SESSION['btn_guardar_actividad']; ?>><i class="zmdi zmdi-floppy"></i> Guardar</button>
                                    </p>
