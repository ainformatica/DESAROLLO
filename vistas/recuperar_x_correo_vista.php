      ...
      <div class="card-body login-card-body">
        ...
        <form action="../Controlador/verificar_correo_usuario_controlador.php?idusuario=<?php echo $id_usuario ?>" method="post">
          ...
          <div class="input-group mb-3">
            <input type="email" class="form-control" id="correoclave" name="correoclave"  onkeyup="Espacio(this, event)" maxlength="50"  placeholder="Correo Electronico" required="required">
