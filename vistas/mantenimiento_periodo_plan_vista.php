...
if ($visualizacion == 0) {
    ...
    if (permisos::permiso_modificar($Id_objeto) == '1') {
        $_SESSION['btn_modificar_periodo_plan'] = "";
    } else {
        $_SESSION['btn_modificar_periodo_plan'] = "disabled";
    }


    /* Manda a llamar todos las datos de la tabla para llenar el gridview  */
    $sqltabla = "SELECT * FROM tbl_periodo_plan";
    $resultadotabla = $mysqli->query($sqltabla);
 ...
 tabla donde rol sea igual al que se ingreso en el input */
        $sql = "SELECT * FROM tbl_periodo_plan WHERE periodo = '$periodo'";
        ...
        $_SESSION['id_periodo_plan'] = $row['id_periodo_plan'];
...
?>
            <script>
                $(function() {
                    $('#modal_modificar_periodo_plan').modal('toggle')
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1>Período de Plan de Estudios
                        </h1>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Período</label>
                                        <input class="form-control" type="text" id="periodo" name="periodo" value="<?php echo $_SESSION['periodo']; ?>" onkeyup=" MismaLetra('periodo'); DobleEspacio(this, event);">
                                    </div>
                                </div>
                            </div>
                        </div>
