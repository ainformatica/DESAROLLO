...
if ($visualizacion == 0) {
    echo '<script type="text/javascript">
                           ...
                           window.location = "../vistas/mantenimiento_tipos_recursos.php";
            ...
            var table = $("#tabla_recursos_tipo").DataTable({
               ...
               dom: 'Bfrtip',
                buttons: [{
                    ...
                    {
                        extend: 'pdf',
                        title: 'UNIVERSIDAD NACIONAL AUTONOMA DE HONDURAS REGISTRO DE MANTENIMIENTO DE RECURSOS OPERATIVOS',
