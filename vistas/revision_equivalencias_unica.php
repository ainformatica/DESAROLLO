        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../vistas/menu_revison_equivalencias.php">Solicitudes Equivalencias</a></li>
            </ol>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  $listar = null;
                  $directorio = opendir("../archivos/equivalencias/$tipo/$cuenta");
                  while ($elemento = readdir($directorio)) {
                    if ($elemento != '.' and $elemento != '..') {


                      if (is_dir("../archivos/equivalencias/$tipo/$cuenta/" . $elemento)) {
                        $listar .= "<li> <a href='../archivos/equivalencias/$tipo/$cuenta/$elemento' target='_blank'>$elemento/</a></li>";
                      } else {
                        $listar .= "<li> <a href='../archivos/equivalencias/$tipo/$cuenta/$elemento' target='_blank'>$elemento</a></li>";
                      }
                    }
