...
bitacora::evento_bitacora($Id_objeto, $_SESSION['id_usuario'], 'INGRESO', 'A MANTENIMIENTO ESTADO PARRTICIPANTE');
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <li class="breadcrumb-item"><a href="pagina_principal_vista">Inicio</a></li>
                            ...
                            <li class="breadcrumb-item active">Estado Participante</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="modal-content lg-secondary ">
                        ...
                        <form role="form" name="guardar-estadoparticipante" id="guardar-estadoparticipante" method="post" action="../Modelos/modelo_manparticipante.php">
                            ...
                            <div class="card-footer">
                                <input type="hidden" name="estado-participante" value="nuevo">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form role="form" name="guardar-tiporeu" id="guardar-tiporeu" method="post" action="../Modelos/modelo_manparticipante.php">
                                        <table id="tabla6" class="table table-bordered table-striped table-hover">
                                            <thead>
                                            ...
                                            <tbody>
                                                <?php
                                                try {
                                                    $sql = "SELECT @rownum:=@rownum+1 id_estadoa, estado, id_estado
                                                    FROM tbl_estado_participante t, (
                                                    SELECT @rownum:=0) r";
                                                ...
                                                while ($estadoparticipante = $resultado->fetch_assoc()) { ?>
                                                    <tr>
                                                        <td class="ocultar"><?php echo $estadoparticipante['id_estadoa']; ?></td>
                                                        <td><?php echo $estadoparticipante['estado']; ?></td>
                                                        <td>
                                                            <a href="../vistas/editar_estadoparticipante_vista.php?id=<?php echo $estadoparticipante['id_estado'] ?>" class="btn btn-success <?php echo $_SESSION['btn_editar']; ?>" style="color: while;">
                                                                Editar
                                                            </a>
                                                            <a href="#" data-id="<?php echo $estadoparticipante['id_estado']; ?>" data-tipo="manparticipante" class="borrar_estadoparticipante btn btn-danger <?php echo $_SESSION['btn_borrar']; ?>">
                                                                Borrar
                                                            </a>
                                                        </td>
                                                    </tr>
