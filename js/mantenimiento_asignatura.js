		...
		"buttons": [
		 ...
		 mergeCells.attr('count', mergeCells.attr('count') + 1);
		 ...
		 
			 {
				 ...
				 "title": 'Reporte de asignaturas plan de estudios',  
				 ...
				 "exportOptions": {
					columns: [1, 2, 3, 4, 5, 6, 7, 8,9],
								 ...
								 page: 'current'
								  ...
								  ) +'    HORA: '+ (new Date().getHours()+':'+new Date().getMinutes()+':'+new Date().getSeconds()).toString() + '                                  REPORTE DE ASIGNATURAS ', 
		 ...
		 doc.content[2].table.widths = ["20%", "10%","7%","15%","22%","12%","13%","13%","12%"];
		...
		"buttons": [
		 ...
		 mergeCells.attr('count', mergeCells.attr('count') + 1);
		 ...
		 
			 {
				 ...
				 "pageSize": 'legal',
				 "orientation": 'portrait',
				 "title": 'Reporte de asignaturas de servicio',  
				 "text":   'PDF <i class = "fa fa-print"></i>',
				 "titleAttr":'Exportar a PDF',
				 "className":'btn btn-danger',
		 ...
		 doc.content[2].margin = [ 150, 0, 150, 0 ], //left, top, right, bottom
		 doc.content[2].margin = [0, 15, 100, 0]
		 doc.content[2].table.widths = ["30%", "20%","20%","25%","13%","13%"];
		   doc.styles.tableBodyEven.alignment = 'center';
		   doc.styles.tableBodyOdd.alignment = 'center'; 
