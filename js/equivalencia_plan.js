		...
		"buttons": [
		 ...
		 mergeCells.attr('count', mergeCells.attr('count') + 1);
		 ...
		 
			 {
				 ...
				 "title": 'Reporte de asignaturas-equivalencias',  
				 ...
				 "exportOptions": {
					columns: [1, 2],
								 ...
								 page: 'current'
								  ...
								  ) +'    HORA: '+ (new Date().getHours()+':'+new Date().getMinutes()+':'+new Date().getSeconds()).toString() + '                 REPORTE DE ASIGNATURAS-EQUIVALENCIAS ', 
