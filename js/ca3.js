...
$("#tabla_carga").on("click", ".editar", function () {
  ...
  $("#cbm_tipo_asignatura_edita")
    .val(data.id_tipo_asignatura)
    .trigger("change");
    ...
    buttons: [
      {
        ...
        title: "Reporte de carga académica docentes",
       ...
       /*  message:
        ...
        exportOptions: {
          columns: [13, 3, 4, 6, 7, 8, 9, 10, 11, 1, 2, 12],
          modifier: {
            page: "current",
          },
        },
                ...
                row: _createNode(sheet, "is", {
                  children: {
                    row: _createNode(sheet, "t", {
                     text: "           DEPARTAMENTO DE INFORMÁTICA, UNAH - REPORTE DE CARGA ACADÉMICA DOCENTES ", 
                    }),
                  },
                }),
              },
...

      {
        ...
        title: "Reporte de carga Académica",
...
function modificar_carga_academica() {
  ...
  var selected_modalidad =
    cbm_modalidad_edita.options[cbm_modalidad_edita.selectedIndex].text;
