...
$("#jornada_edita").change(function () {
  var selected_jornada =
    jornada_edita.options[jornada_edita.selectedIndex].text;
...
function persona() {
  document.getElementById("txt_id_persona1").value =
    document.getElementById("txt_id_persona").value;
...
function Actividades() {
  ...
  $.post(
    "../Controlador/gestion_docente_controlador.php?op=Actividades",
...
function modificar_gestion() {
  ...
  if (
    ...
    jornada1 == null ||
    categoria1 == null ||
    (fecha_ingreso.length == 0) | (num_empleado.length == 0) ||
    sued == null
  ) {
    swal({
      title: "¡Alerta!",
